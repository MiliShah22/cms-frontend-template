      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            {/* Email */}
            <div>
              <label className="block text-xs font-semibold mb-1.5 text-[#64748b] tracking-wide">Email Address</label>
            ...
            {/* Password */}
            <div>
              <label className="block text-xs font-semibold mb-1.5 text-[#64748b] tracking-wide">Password</label>
          ...
          <p className="text-center text-xs mt-5 text-[#94a3b8]">
            ...
            <span className="font-semibold text-[#6366f1] cursor-pointer hover:underline">Create one</span>
          </p>
        </div>
      </div>
    </div>
